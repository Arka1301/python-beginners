...
select * from sales
where country in ('United Kingdom','United States', 'Australia');
...
select payment_type, sum(price) as sale_amount,count(*) as total_no, sum(price)/count(*) as avg_sale_per_payment_method
from sales
