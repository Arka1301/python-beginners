...
select avg(strength) as average_strength, avg(intelligence) as average_intelligence, avg(speed) as average_speed
from marvels;
...
select name, intelligence + strength + speed + durability + energy_Projection + fighting_Skills as total_skill
from marvels
order by total_skill desc;

select count(*), case when popularity < 10 then 'Most popular'
            when popularity < 50 then 'Moderately popular'
            else 'Least popular'
        end as 'Popularity_chart'
from marvels
group by popularity_chart;

select * from marvels
where intelligence > 4 and strength > 4 and speed > 4;

select name, intelligence + strength + speed + durability + energy_Projection + fighting_Skills as total_skill
from marvels
group by total_skill
having total_skill > 20;
...
select name from marvels
where energy_Projection >5;

select name from marvels
where fighting_Skills >5;
